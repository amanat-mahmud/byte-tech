    ...
    return (
        <div className="h-full w-full py-8 px-4">
            <div className="flex flex-col items-center justify-center">
                <div className="shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mb-6">
                    ...
                    <button aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1  py-3.5 px-4 border rounded-lg flex items-center w-full mt-10" onClick={()=>signIn("google",{
            callbackUrl:"http://localhost:3000"
                    ...
                    <button aria-label="Continue with github" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 py-3.5 px-4 border rounded-lg  flex items-center w-full mt-4" onClick={()=>signIn("github",{
            callbackUrl:"http://localhost:3000"
          })}>
                        ...
                        <p className="text-base font-medium ml-4">Continue with Github</p>
                    </button>
                    <button aria-label="Continue with twitter" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 py-3.5 px-4 border rounded-lg  flex items-center w-full mt-4">
                        ...
                        <p className="text-base font-medium ml-4">Continue with Twitter</p>
                    </button>
                    ...
                    <div>
                        <lable className="text-sm font-medium leading-none ">Email</lable>
                        <input role="input" type="email" className="border rounded focus:outline-none text-xs font-medium leading-none py-3 w-full pl-3 mt-2" />
                    </div>
                    <div className="mt-6  w-full">
                        <lable className="text-sm font-medium leading-none ">Password</lable>
                        <div className="relative flex items-center justify-center">
                            <input aria-label="enter Password" role="input" type="password" className=" border rounded focus:outline-none text-xs font-medium leading-none  py-3 w-full pl-3 mt-2" />
                    ...
                    <div className="mt-8">
                        <button role="button" aria-label="create my account" className="btn btn-accent w-full">
                            Sign in 
                        </button>
                    </div>
                </div>
