        ...
        <div className="h-full w-full py-8 px-4">
            <div className="flex flex-col items-center justify-center">
                <div className="shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mb-6">
                    ...
                    <button aria-label="Continue with github" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 py-3.5 px-4 border rounded-lg  flex items-center w-full mt-4">
